...
```bash
./odoo/odoo-bin --addons-path=/root/odoo/odoo-from-13-to-18/arquitectura/odoo19/clientes/integraia_19/extra-addons/extra -d dbcontabo19 --i18n-export=clientes/integraia_19/extra-addons/extra/evolution-api/i18n/evolution_api.pot --modules=evolution-api -c clientes/integraia_19/conf/odoo.cfg
```
...
./odoo/odoo-bin --addons-path=/root/odoo/odoo-from-13-to-18/arquitectura/odoo19/clientes/integraia_19/extra-addons/extra -d dbcontabo19 -u evolution-api -c clientes/integraia_19/
conf/odoo.cfg
# FIN MULTI LENGUAJE

...
class S25PrinterData(object):
            ...
            if len(trama) > 69:
                try:
                    ...
                    if len(_arrayParameter) > 1:
                        ...
                        self._setMontoPagarIgtf(Util().DoValueDouble(_arrayParameter[2][1:]))
    ...
    def montoPagarIgtf(self):
        return self._montoPagarIgtf
    ...
    def _setMontoPagarIgtf(self, montoPagarIgtf):
        self._montoPagarIgtf = montoPagarIgtf

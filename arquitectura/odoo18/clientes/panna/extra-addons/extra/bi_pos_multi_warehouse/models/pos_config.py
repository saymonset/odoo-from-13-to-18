...
class PosConfigLocationwarehouse(models.Model):
    ...
    display_stock = fields.Boolean(
        string="Display stock in pos", help="Allow display stock in pos."
    )
    default_location_src_id = fields.Many2one(
        "stock.location", "Default Stock Location", check_company=True
    )

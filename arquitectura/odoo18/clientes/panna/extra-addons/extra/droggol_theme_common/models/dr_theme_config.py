...
class DrThemeConfig(models.Model):
        ...
        for config in all_config:
            try:
                if config.key.startswith("bool_"):
                    ...
                    if isinstance(config_value, dict) and result_configs.get(
                        config.key
                    ):
                ...
                _logger.warning(
                    "Theme Prime Config: Cannot parse '%s' with value '%s' ",
                    config.key,
                    config.value,
                )
            except ValueError:
    ...
    def _get_default_theme_config(self, website_id):
        ...
        return {
            "json_sidebar_config": {
                "category_sidebar_style": "2",
                "category_sidebar_show_count": True,
                "menu_sidebar_show_category": True,
                "cart_sidebar_free_delivery_progress": False,
            },
            "json_shop_layout": {
                "layout": "prime",
            ...
            "json_shop_product_item": {
                ...
                "show_product_preview_swatches": True,
                "show_rating": True,
            ...
            "json_shop_filters": {
                ...
                "collapsible_category": True,
                "collapsible_attribute": True,
            ...
            "json_product_recent_sales": {
                "enabled": True,
                "mode": "fake",
                "fake_min_threshold": 3,
                "fake_max_threshold": 15,
                "duration": 24,
            },
            "json_product_view_count": {
                "enabled": True,
                "mode": "fake",
                "fake_min_threshold": 2,
                "fake_max_threshold": 10,
            },
            "bool_enable_ajax_load": False,
            "json_bottom_bar": {
                "show_bottom_bar": True,
                "show_bottom_bar_on_scroll": False,
                "filters": True,
                "actions": [
                    "tp_home",
                    "tp_search",
            ...
            "json_b2b_shop_config": {
                "dr_enable_b2b": False,
                "dr_only_assigned_pricelist": False,
            },
            "json_mobile": {},
            "json_product_search": {
                "advance_search": True,
                ...
                "search_limit": 8,
                "pills_limit": 5,
                "search_max_product": 6,
                "search_fuzzy": True,
                "search_fill_products": False,
                "search_report": True,
                "delete_search_report": 90,
            },
            "json_brands_page": {"disable_brands_grouping": False},
            "cart_flow": "default",
            "theme_installed": website.theme_id
            and website.theme_id.name.startswith("theme_prime")
            or False,

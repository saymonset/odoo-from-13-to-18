...
class WebsiteMenu(models.Model):
    ...
    dr_highlight_menu_bg_color = fields.Char(
        "Hightlight Background Color", default="#000000"
    )
    dr_highlight_menu_text_color = fields.Char(
        "Hightlight Text Color", default="#FFFFFF"
    )
    dr_menu_visible_on = fields.Selection(
        [("all", "All Devices"), ("desktop", "Only Desktop")],
        string="Menu Visible On",
        default="all",
        required=True,
    )

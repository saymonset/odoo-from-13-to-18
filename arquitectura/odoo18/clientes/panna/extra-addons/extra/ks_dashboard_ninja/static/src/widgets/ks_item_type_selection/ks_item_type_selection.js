...
export class KsDashboarditemtype extends Component {
  ...
  onselectitemtype(ev) {
    var ks_active_target =
      ev.currentTarget.parentElement.querySelectorAll(".active");
    ks_active_target.forEach(function (item) {
...
registry
  .category("fields")
  .add("ks_dashboard_item_type", KsDashboarditemtypeField);

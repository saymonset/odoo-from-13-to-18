...
export class ks_funnel_chart extends Component {
  ...
  _Ks_render() {
    ...
    var graphTextElements =
      self.funnelRef.el.querySelectorAll("div.graph_text");
    graphTextElements.forEach(function (el) {
      el.remove();
    });
  ...
  get_funnel_chart(rec) {
    var graphTextElements = this.funnelRef.el.querySelectorAll(".graph_text");
    ...
    if (this.props.record.data.ks_chart_data) {
      ...
      if (keyValueArray.length) {
        ...
        if (
          this.props.record.data.ks_show_data_value &&
          this.props.record.data.ks_data_label_type == "value"
        ) {
          series.labels.template.set("text", "{value}");
        } else if (
          this.props.record.data.ks_show_data_value &&
          this.props.record.data.ks_data_label_type == "percent"
        ) {
        ...
        this.funnelRef.el.innerHTML += renderToString("ksNoItemChartView", {});
      }
    } else {
      this.funnelRef.el.innerHTML += renderToString("ksNoItemChartView", {});
    }

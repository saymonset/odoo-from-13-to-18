...
class KsItemPreview extends Component {
  ...
  get value() {
    ...
    item_info = {
      ...
      count_tooltip: formatFloat(field.ks_record_count, {
      ...
      ks_rgba_font_color: self._get_rgba_format(field.ks_font_color),
      ks_rgba_icon_color: self._get_rgba_format(field.ks_default_icon_color),
      ks_rgba_dark_background_color_l2: self._get_rgba_format(
    ...
    if (field.ks_icon) {
      if (!self.isBinSize(field.ks_icon)) {
        ...
        item_info["img_src"] =
          "data:image/" +
          (self.file_type_magic_word[field.ks_icon] || "png") +
          ";base64," +
          field.ks_icon;
      } else {
...
registry
  .category("fields")
  .add("ks_dashboard_item_preview_owl", KsItemPreviewfield);
